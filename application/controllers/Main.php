...
class Main extends CI_Controller {
    ...
    function index()
    {
        $data = array(
            ...
            'listPublishers'    => $this->mPub->get_all(),
            'seniman_data' => $this->mPub->getPublist(),
    ...
    function search_event()
    {
        ...
        $seniman  = $this->input->get('seniman');
        $category = $this->input->get('kategori');
        $city     = $this->input->get('kota');
        // $tahun_karya = $this->input->get('tahun_karya');
        

        $event    = $this->mEvent->cariEvent($keyword,$category,$city,$seniman);
        $kategori = $this->mMaster->getCategory();
        $kota     = $this->mMaster->getCity();
        $seniman = $this->mPub->getPublist();
        ...
        $data = array(
            ...
            'kota_data'     => $kota,
            // 'tahun_karya'   => $tahun_karya,
            'seniman_data'    => $seniman,
        );
