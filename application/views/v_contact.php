        ...
        <div class="row">
          <div class="col-lg-3">
            <div class="contact_info">
              <div class="info_item">
                <i class="ti-home"></i>
                <h6>Kab. Tangerang, Indonesia</h6>
                <p>Kelapa Dua Kab. Tangerang Indo</p>
              </div>
              <div class="info_item">
                <i class="ti-headphone"></i>
                <h6><a href="#">(+62) 81237-620841</a></h6>
                <p>Mon to Fri 9am to 5 pm</p>
              </div>
              <div class="info_item">
                <i class="ti-email"></i>
                <h6><a href="#">tornaduy@gmail.com</a></h6>
