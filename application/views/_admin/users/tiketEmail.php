...
<div class='card mb-3 border-primary' style='max-width: 28rem; font-size: 14px;'>
  <h4 class='card-header text-white bg-primary text-center'>TORNADUY.id</h4>
  <div class='card-body'>
    ...
    <p style='margin-top:10px;margin-bottom:10px'>Informasi lebih lanjut silahkan hubungi kami <a href='#'>TORNADUY.id</a></p>
  </div>
</div>