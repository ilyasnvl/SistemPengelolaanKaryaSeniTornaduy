	...
	<section class="content">
		<div class="box box-solid">
			<div class="box-header with-border">
				...
				<h3 style="margin-top:0px"><i class="fa fa-calendar-o"></i> Karya Seni</h3>
						...
						<?php if ($_SESSION['role'] == 'adm') { 
							if ($event->status == 'submitted') { ?>
								<a href="<?= site_url('admin/event/'.$event->id.'/terima') ?>" class="btn btn-success"
									onclick="return confirm('Apakah anda ingin menyetujui karya ini ?')">Setujui</a>
		...
		<div class="box box-solid">
			<div class="box-header with-border">
				<h3 style="margin-top:0px">Deskripsi dan Pembelian</h3>
			</div>    
			<div class="box-body">
				<div class="row">
					<div class="col-md-12">
					<div class="nav-tabs-custom">
						<ul class="nav nav-tabs">
							<li class="active"><a href="#deskripsi" data-toggle="tab">Deskripsi Karya</a></li>
							<li><a href="#tiket" data-toggle="tab">Informasi(<?= $totalTiket ?>)</a></li>
							<li><a href="#peserta" data-toggle="tab">Peserta (<?= $totalPeserta ?>)</a></li>
							<li><a href="#penjualanTiket" data-toggle="tab">Penjualan Karya</a></li>
						</ul>
	...
	<div class="modal-dialog">
		<div class="modal-content">
			<div class="modal-header">
				...
				<h4 class="modal-title">Reject Karya</h4>
			</div>
