...
<div class="content-wrapper">
    ...
    <section class="content">
            ...
            <div class="box-body">
                <div class="row">
                    ...
                    <div class="col-md-6 col-xs-12">
                        ...
                        <p>
                            <i class="fa fa-user"> </i> Seniman: <?= $event->publisher_name ?>
                        </p>
                        <p>
        ...
        <div class="box box-solid">
            <div class="box-header with-border">
                <h3 style="margin-top:0px">Detail Penjualan Karya</h3>
            </div>
            <div class="box-body">
                <div class="row">
                    <div class="col-md-12">
                        <table class="table table-striped table-hover">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td style="text-align: center"><?= $pt->ticket_name ?></td>
                                    ...
                                    <td style="text-align: center"><?= '@ ' . 'Rp ' . number_format($pt->price, '0', '', '.') ?></td>
                                </tr>
                                <?php } ?>
                            </tbody>
                        </table>
        ...
        <div class="box box-solid">
            <div class="box-header with-border">
                <h3 style="margin-top:0px">Detail Pembeli Karya</h3>
            </div>
            <div class="box-body">
                <div class="row">
                    <div class="col-md-12">
                        <table class="table table-striped table-hover" id="detail_pembeli">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td><?= $hp['user_name'] ?></td>
                                    <td style="text-align: center"><?= 'Rp ' . number_format($hp['ticket_price'], '0', '', '.') ?></td>
                                    <td style="text-align: center"><?= 'Rp ' . number_format($hp['fee_admin'], '0', '', '.') ?></td>
                                    <td style="text-align: center"><?= 'Rp ' . number_format($hp['final_price'], '0', '', '.') ?></td>
                                </tr>
                                <?php } ?>
                            </tbody>
                        </table>
