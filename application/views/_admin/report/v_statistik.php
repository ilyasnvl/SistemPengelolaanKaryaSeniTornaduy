                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <table class="table table-striped">
                                    <tr><td colspan="3"><div class="user-square"></div> User</td></tr>
                                    <tr>
                                ...
                                <table class="table table-striped">
                                    <tr><td colspan="3"><div class="pub-square"></div> Seniman</td></tr>
                                    <tr>
                                        <th width="100" style="text-align: center">Total Seniman</th>
                    ...
                    <div class="box-body">
                        ...
                        <div class="nav-tabs-custom my-5">
                            <ul class="nav nav-tabs">
                                <li class="active"><a href="#top_peserta" data-toggle="tab">karya Pembelian Terbanyak</a></li>
                                <li><a href="#top_penjualan" data-toggle="tab">Karya Pendapatan terbanyak</a></li>
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="alert alert-dismissible" style="background-color: #D81B60; color: white">
                                                Karya dengan <b>pembelian</b> terbanyak
                                            </div>
                                ...
                                <div class="tab-pane" id="top_penjualan">
                                    <div class="row">
                                        ...
                                        <div class="alert bg-purple alert-dismissible">
                                            Karya dengan <b>pendapatan</b> terbanyak
                                        </div>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                Total karya yang tercatat dalam sistem adalah : <strong><?= number_format($countAllEvent,'0','','.') ?></strong>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div class="row">
            <div class="col-xs-4">
                <div class="box box-warning">
                    <div class="box-header with-border">
                        <i class="fa fa-user-o"></i>Top Seniman
                        <div class="box-tools pull-right">
                            <button type="button" class="btn btn-box-tool" data-widget="collapse"><i class="fa fa-minus"></i>
                            </button>
                            <button type="button" class="btn btn-box-tool" data-widget="remove"><i class="fa fa-times"></i></button>
            ...
            <div class="col-xs-4">
                <div class="box box-info">
                    <div class="box-header with-border">
                        <i class="fa fa-money"></i>Penjualan Karya Seni
                        <div class="box-tools pull-right">
                            <button type="button" class="btn btn-box-tool" data-widget="collapse"><i class="fa fa-minus"></i>
                            </button>
                            <button type="button" class="btn btn-box-tool" data-widget="remove"><i class="fa fa-times"></i></button>
                    ...
                    <div class="box-body" style="height:280px">
                        <p>Total pendapatan karya sampai tanggal <strong><?= date_indo(date('Y-m-d')) ?></strong></p>
                        <h3></h3>
