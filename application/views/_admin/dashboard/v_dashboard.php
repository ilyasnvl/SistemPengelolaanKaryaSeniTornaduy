      ...
      <div class="row">
        <div class="col-md-8">
          <div class="box box-success">
            ...
            <a href="<?= site_url('event') ?>" class="btn-xs btn-success pull-right" data-toggle="tooltip" data-placement="top" title="Semua Event">
                ...
                <h3 style="margin-top:0px"><i class="fa fa-calendar-o"></i> Karya baru</h3>
            </div>    
            <div class="box-body">
        ...
        <div class="col-md-4">
          ...
          <div class="info-box bg-red">
              ...
              <div class="info-box-content">
                <span class="info-box-text">Total Seniman</span>
                <span class="info-box-number"><?= $total_pub ?></span>
                <div class="progress">
                  <div class="progress-bar" style="width: 100%"></div>
                </div>
                  <span class="progress-description">
                    Hari ini bertambah +<?= $pub_this_day ?> seniman
                  </span>
              </div>
            <!-- /.info-box-content -->
          </div>
          <div class="info-box bg-green">
              ...
              <div class="info-box-content">
                <span class="info-box-text">Total Karya</span>
                <span class="info-box-number"><?= $total_event ?></span>
                <div class="progress">
                  <div class="progress-bar" style="width: 100%"></div>
                </div>
                  <span class="progress-description">
                    Hari ini bertambah +<?= $event_this_day ?> Karya
                  </span>
              </div>
            <!-- /.info-box-content -->
          </div>
