...
<aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="<?php if($title == 'Karya Seni') echo "active" ?>">
          <a href="<?= site_url('admin/event') ?>">
            <i class="fa fa-calendar-o"></i> <span>Karya Seni</span>
        ...
        <li class="<?= $dataMaster ?>">
          ...
          <ul class="treeview-menu">
            ...
            <li class="<?php if($title == 'Kategori Event') echo "active" ?>"><a href="<?= site_url('admin/kategori-event') ?>"><i class="fa fa-circle-o"></i> Kategori Karya</a></li>
        ...
        <li class="<?= $dataPengguna ?>">
          ...
          <ul class="treeview-menu">
            <!-- user -->
            <li class="<?php if($title == 'Users')?>"><a href="<?= site_url('admin/peserta') ?>"><i class="fa fa-circle-o"></i> User
              <span class="pull-right-container">
                <small class="label pull-right bg-green"><?= $jumlah_user ?></small>
              </span>
            </a></li>
            <!-- publisher -->
            <li class="<?php if($title == 'Publisher')?>"><a href="<?= site_url('admin/publisher') ?>"><i class="fa fa-circle-o"></i> Seniman
              <span class="pull-right-container">
                <small class="label pull-right bg-green"><?= $jumlah_publisher ?></small>
              </span>
            </a></li>
          </ul>
