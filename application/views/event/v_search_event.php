                        ...
                        <div class="card-body">
                            <div class="row">
                                <div class="col-6 col-md-2 col-lg-2">
                                    <label for="nama event">Nama Karya</label>
                                    <input type="text" name="keyword" id="keyword" class="form-control" value="<?=  $_GET['keyword'] ; ?>">
                                    </div>
                                    <div class="col-6 col-md-2 col-lg-2">
                                        <label for="seniman">Seniman</label>
                                        <select name="seniman" id="seniman" class="selectpicker form-control" data-live-search="true" data-size="6">
                                        <option value="">Pilih Seniman</option>
                                        <?php foreach ($seniman_data as $row) { ?>
                                            <option value="<?= $row->id ?>" <?= $selected = ($row->id == $_GET['seniman']) ? "selected" : ""?>>
                                            <?= $row->name ?></option>
                                            <?php } ?>
                                        </select>
                                    </div>
        ...
        <div class="row wow fadeInUp">
            ...
            {            
                foreach ($event_data as $row) { 
                    ...
                    $endDate = date('Y-m-d',strtotime($row->end_time));
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="row">
                                        <div class="col-12" style="font-size:14px">
                                            ...
                                            <!-- <i class="fa fa-solid fa-user-check"></i> Seniman : <?= $row->publisher_name ?><br> -->
                                            <i class="fa fa-calendar-check-o"></i> Tahun Karya : <?= $row->tahun_karya ?><br>
                                            <i class="fa fa-map-marker"></i> Lokasi : <?= $row->city_name ?><br>
                                            <i class="fa fa-solid fa-bars"></i> Kategori : <?= $row->category_name ?>
                                            <p class="mt-3">
            ...
            <div class="col-12">
                <h5 style="margin: 0px 0px 150px 0px">
                    Data karya belum tersedia <img src="<?= base_url('assets/icons/icons/clock.svg') ?>" alt="" width="24" height="24">
                </h5>
            </div>
            <?php } ?>
        </div>
