            ...
            <div class="col-lg-4 right-contents">
                <ul>
                    ...
                    <li>
                        <a class="justify-content-between d-flex" href="#">
                            <p>Tahun karya</p>
                            <span class="or"><?= $event->tahun_karya ?></span>
                        </a>
                    </li>
                    <li>
                        <a class="justify-content-between d-flex" href="#">
                            <p>Media</p>
                            <span class="or"><?= $event->media ?></span>
                        </a>
                    </li>
                    <li>
                        <a class="justify-content-between d-flex" href="#">
                            <p>Dimensi</p>
                            <span class="or"><?= $event->dimensi ?></span>
                        </a>
                    </li>
                    <!-- <li>
                        <a class="justify-content-between d-flex" href="#">
                ...
                <a href="#" class="primary-btn text-uppercase enroll rounded-0" data-toggle="modal"
                    data-target="#tiket">Lihat Harga</a>
                <?php else :
					if ($isRegister == TRUE) : ?>
                ...
                <?php elseif (date('Y-m-d', strtotime($event->end_time)) < date('Y-m-d')) : ?>
                <a>
                ...
                <a href="#" class="primary-btn text-uppercase enroll rounded-0 text-white" data-toggle="modal"
                    data-target="#tiket">Beli Karya Seni</a>
                <?php endif ?>
                <?php endif ?>
                    ...
                    <span class="list-group-item list-group-item-action list-group-item-warning">
                        ...
                        <div class="float-right">
                            ...
                            <a href="<?= site_url('konfirmasi-booking/' . $event->id . '/' . $tiket->id) ?>"
                                class="badge badge-success">Beli Karya Seni</a>
                            <?php else : ?>
                            <a href="#" class="badge badge-secondary">Stok Habis</a>
                            <?php endif ?>
                            <?php endif ?>
                        </div>
                        <p class="mb-1"><?= $tiket->description ?></p>
                        <small><?= 'Karya tersisa untuk dibeli ' . $tiket->quota . ' lagi' ?></small>
                    </span>
                    <?php endforeach ?>
                </div>
            </div>
