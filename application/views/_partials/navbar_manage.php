<li class="nav-item">
    <?php if ($navbar_manage == 'description') { ?>
        ...
        <i class="fa fa-calendar"></i> <u style="color:inherit">Informasi Karya Seni</u></a>
    <?php } else { ?>
        <a class="nav-link" href="<?= site_url('manage/'.$id) ?>" style="color:inherit">
		<i class="fa fa-calendar"></i> Informasi Karya Seni</a>
    <?php } ?>
</li>
<li class="nav-item">
    <?php if ($navbar_manage == 'ticket') { ?>
	    <a class="nav-link active" id="tiket-tab" data-toggle="tab" href="#tiket" style="color:inherit"
		role="tab"><i class="fa fa-ticket"></i> <u style="color:inherit">Informasi Harga</u></a>
    <?php } else { ?>
        <a class="nav-link" href="<?= site_url('manage/'.$id.'/tiket') ?>" style="color:inherit">
		<i class="fa fa-ticket"></i> Informasi Harga</a>
    <?php } ?>
</li>
<li class="nav-item">
    <?php if ($navbar_manage == 'ticket-sales') { ?>
	    <a class="nav-link active" id="selltiket-tab" data-toggle="tab" href="#selltiket" style="color:inherit" role="tab"><i class="fa fa-money"></i> <u style="color:inherit">Penjualan Karya</u></a>
    <?php } else { ?>
        <a class="nav-link" href="<?= site_url('manage/'.$id).'/penjualan-tiket' ?>" style="color:inherit">
		<i class="fa fa-money"></i> Penjualan Karya</a>
    <?php } ?>
</li>
<li class="nav-item">
    <?php if ($navbar_manage == 'audience') { ?>
	    <a class="nav-link active" id="peserta-tab" data-toggle="tab" href="#peserta" style="color:inherit" role="tab"><i class="fa fa-user-o"></i> <u style="color:inherit">Pembeli</u></a>
    <?php } else { ?>
        <a class="nav-link" href="<?= site_url('manage/'.$id.'/peserta') ?>" style="color:inherit">
		<i class="fa fa-user-o"></i> Pembeli</a>
    <?php } ?>
</li>
<!-- <li class="nav-item">
