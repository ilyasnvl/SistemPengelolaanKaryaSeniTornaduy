    ...
    <div class="main_menu">
        <nav class="navbar navbar-expand-lg navbar-light">
            <div class="container">
                ...
                <a href="<?= base_url() ?>">
                    <img src="<?= base_url('assets/images/images-site/tornaduy1.png') ?>" height="100" width="150px"
                        class="img-fluid">
                </a>
                ...
                <div class="collapse navbar-collapse offset" id="navbarSupportedContent">
                    <ul class="nav navbar-nav menu_nav ml-auto">
                        ...
                        <?php else : ?>
                        <li class="nav-item">
                            <a class="nav-link" href="<?= site_url('manage') ?>"><i class="fa fa-plus"></i> Buat
                                Karya</a>
                        </li>
                        <li class="nav-item submenu dropdown">
                            <a href="#" class="nav-link dropdown-toggle" data-toggle="dropdown" role="button"
                                aria-haspopup="true" aria-expanded="false">Halo, <?= $nama ?></a>
                            <ul class="dropdown-menu">
                                <li class="nav-item">
                                    <a class="nav-link" href="<?= site_url('profil-saya') ?>"><i
                                            class="fa fa-user-o"></i> Profil Saya</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" href="<?= site_url('tiket-saya') ?>"><i
                                            class="fa fa-ticket"></i> Transaksi Saya
                                        (<?= $tiketAktif ?>)</a>
                                </li>
                                <li class="nav-item">
