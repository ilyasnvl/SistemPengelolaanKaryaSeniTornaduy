            ...
            <div class="col-lg-12">
              <div class="banner_content text-center">
                <p class="text-uppercase">
                  Tempat terbaik untuk memamerkan karya
                </p>
                <h2 class="text-uppercase mt-4 mb-5" >
                  Satu Langkah Mudah Memamerkan Karya
                </h2>
                <div>
                  <!-- <a href="#" class="primary-btn2 mb-3 mb-sm-0">learn more</a> -->
                  <a href="<?= site_url('cari-event?keyword=&seniman=&kategori=&kota=') ?>" class="primary-btn ml-sm-3 ml-0">Lihat karya</a> <br> <br>
                </div>
              </div>
            </div>
          </div>
        ...
        <div class="row">
          <div class="col-lg-6 col-md-4">
            <div class="single_feature">
              ...
              <div class="desc">
                <h4 class="mt-3 mb-2">Penjualan karya Online</h4>
                <p>
                  Penjualan karya secara online dapat memudahkan pembeli
                </p>
              </div>
            </div>
          </div>
          ...
          <div class="col-lg-6 col-md-4">
            <div class="single_feature">
              ...
              <div class="desc">
                ...
                <p>
                  TORNADUY mendukung penetakan sertifikat secara langsung
                </p>
              </div>
            </div>
          </div>
    ...
    <div class="popular_courses">
      <div class="container">
        <div class="row justify-content-center">
          <div class="col-lg-5">
            <div class="main_title">
              <h2 class="mb-3">Karya Terbaru</h2>
              <p>
                Temukan karya terbaikmu disini
              </p>
            </div>
          </div>
        </div>
        <div class="row justify-content-center">
          ...
          <?php if ($event_data): ?>
                    ...
                    <div class="course_content" style="min-height:310px">
                        ...
                        <p>
                            <table>
                                ...
                                <tr>
                                  <td style="font-size: 14px;"><i class="fa fa-calendar-check-o"></i> Tahun Karya </td>
                                  <td> : </td>
                                  <td style="font-size: 14px;"><?= $row->tahun_karya ?></td>
                                </tr>
                                <tr>
            ...
            <?php else: ?>
                <p align="center" class="mb-3">karya sedang disiapkan, sabar ya kak :)</p>
            <?php endif ?>
          </div>

          <a href="<?= site_url('cari-event?keyword=&kategori=&kota=') ?>" class="genric-btn primary circle arrow">Lihat semua karya<span class="ti-arrow-right"></span></a>
        </div>
      </div>
    </div>
          ...
          <div class="col-lg-7">
            <div class="row clock_sec clockdiv" id="clockdiv">
              <div class="col-lg-12">
                ...
                <p>
                  Ayo daftarkan dirimu sekarang juga dan cari karya terbaikmu, kami menyediakan 
                  banyak karya dari berbagai Seniman ternama. Daftarkan dirimu sekarang 
                  dan temukan karyamu.
                </p>
              </div>
            </div>
        ...
        <div class="row justify-content-center">
          <div class="col-lg-5">
            <div class="main_title">
              ...
              <p>
                Selalu up to date dengan berita terbaru dari TORNADUY.id
              </p>
            </div>
          </div>
        </div>
