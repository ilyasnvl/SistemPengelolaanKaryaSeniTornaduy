        ...
        <div class="container">
            <div class="card shadow my-3 wow fadeInUp">
                <div class="card-body">
                    <div class="row">
                        <div class="col-md-12">
                            <h4><strong>Konfirmasi Pembelian</strong></h4>
                            <hr>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-6">
                            <h5><strong>Informasi Karya</strong></h5>
                            <table class="table table-striped table-hover">
                                <tr>
                                    <td style="width:200px">Nama karya</td>
                                ...
                                <!-- <tr>
                                    ...
                                    <td style="width:20px">:</td>
                                    <td><?= $tanggalEvent = ($startDate == $endDate) ? date_indo($startDate) : date_indo($startDate) . ' - ' . date_indo($endDate); ?>
                                    </td>
                                </tr>
                                <tr>
                            ...
                            <h5 class="mt-3"><strong>Informasi Pembelian</strong></h5>
                            <table class="table table-striped">
                                <!-- <tr>
                                    <td style="width:200px">Nama Pembelian</td>
                                    <td style="width:20px">:</td>
                                    <td><?= $tiket->name ?></td>
                                </tr> -->
                                <tr>
                        ...
                        <div class="col-md-6 mt-30">
                            <img src="<?= base_url('assets/images/images-event/' . $event->image) ?>" width="500"
                                height="250">
                        </div>
                    </div>
                    <div class="row my-3">
                        <div class="col-md-12">
                            <a href="<?= site_url('booking/' . $event->id . '/' . $tiket->ticket_id) ?>"
                                class="btn btn-success"
                                onclick="return confirm('Apakah anda ingin memesan karya ini ?')">Pesan</a>
                            <a href="<?= site_url('event/v/' . $event->slug) ?>" class="btn btn-danger"
