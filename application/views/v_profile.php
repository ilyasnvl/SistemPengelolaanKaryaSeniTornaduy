            ...
            <div class="col-lg-12">
                <div class="main_title text-left">
                    ...
                    <div class="row">
                        <div class="col-lg-4">
                            <div class="card" style="width: 18rem;">
                                <img src="<?= base_url('assets/images/images-user/' . $user->profile_picture) ?>"
                                    class="card-img-top" alt="Image of <?= $user->name ?>">
                                <div class="card-body text-center">
                                    <small><a href="<?= site_url('ubah-profil') ?>"
                                            style="text-decoration:none; color: inherit;"><i class="fa fa-edit"></i>ubah
                                            profile</a></small> <br> <br>
                            ...
                            <nav>
                                <div class="nav nav-tabs" id="nav-tab" role="tablist">
                                    <a class="nav-item nav-link active" id="nav-home-tab" data-toggle="tab"
                                        ...
                                        <i class="fa fa-calendar-check-o"></i> Karya yang dimiiki</a>
                                </div>
                            </nav>
                            <div class="tab-content" id="nav-tabContent">
                                <div class="tab-pane fade show active" id="nav-event" role="tabpanel"
                                    ...
                                    <table class="table table-hover table-striped table-bordered">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                <td><?= ++$start ?></td>
                                                <td><a href="<?= site_url('event/v/' . $event->title) ?>"
                    ...
                    <div class="row mt-3">
                        ...
                        <div class="col-12">
                            ...
                            <div class="alert alert-warning alert-dismissible fade show" role="alert">
                                Silahkan lengkapi <strong>profil seniman</strong> anda untuk membuat karya :)
                            </div>
                            <?php } ?>
                    ...
                    <div class="row">
                        <div class="col-lg-4">
                            <div class="card" style="width: 18rem;">
                                <img src="<?= base_url('assets/images/images-publisher/' . $publisher->image) ?>"
                                    class="card-img-top" style="height:250px" alt="Image of <?= $publisher->name ?>">
                                <div class="card-body text-center">
                                    <small><a href="<?= site_url('p/ubah-profil') ?>"
                                            style="text-decoration:none; color: inherit;"><i class="fa fa-edit"></i>ubah
                                            profile</a></small> <br> <br>
                                    <p class="font-weight-bold" style="margin-bottom:0px">My Bio</p>
                        ...
                        <div class="col-lg-8">
                            <nav>
                                <div class="nav nav-tabs" id="nav-tab" role="tablist">
                                    <a class="nav-item nav-link active" id="nav-home-tab" data-toggle="tab"
                                        href="#nav-profile" role="tab" aria-controls="nav-home" aria-selected="true">
                                        <i class="fa fa-user"></i> Profil Seniman</a>
                                </div>
                            </nav>
                            <div class="tab-content" id="nav-tabContent">
                                <div class="tab-pane fade show active" id="nav-profile" role="tabpanel"
                            ...
                            <nav>
                                <div class="nav nav-tabs" id="nav-tab" role="tablist">
                                    <a class="nav-item nav-link active" id="nav-home-tab" data-toggle="tab"
                                        href="#nav-event" role="tab" aria-controls="nav-home" aria-selected="true">
                                        <i class="fa fa-calendar-check"></i> Karya yang dimiliki</a>
                                </div>
                            </nav>
                            <div class="tab-content" id="nav-tabContent">
                                <div class="tab-pane fade show active" id="nav-event" role="tabpanel"
                                    ...
                                    <table class="table table-hover table-striped table-bordered">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                <td><?= ++$start ?></td>
                                                <td><a href="<?= site_url('manage/' . $event->id) ?>"
                                                        style="text-decoration:none; color: inherit;">
                                                        <?= $event->title ?></a></td>
                                                <td><?= $event->status ?></td>
                                            </tr>
