                    ...
                    <div class="card mt-30 shadow wow fadeInUp">
                        <div class="card-body">
                            <div class="section-heading">
                                <h3 class="text-center">Pembayaran Karya Seni</h3>
                                <hr>
                                ...
                                <hr>
                                <form action="<?= site_url('User/Payment/create_action') ?>" method="post"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="file" class="form-control-file" name="payment_image"
                                            value="<?= $payment_image; ?>" accept="image/*" required />
                    ...
                    <div class="card mt-30 shadow wow fadeInUp">
                        <div class="card-body">
                            <div class="section-heading">
                                ...
                                <hr>
                                <h6 style="margin-bottom:0px"><strong>Pembelian Karya seni</strong></h6>
                                <span>Karya Seni - <?= $event_data->title ?></span><br><br>
                                <!-- <h6 style="margin-bottom:0px"><strong>Jenis Karya Seni</strong></h6>
