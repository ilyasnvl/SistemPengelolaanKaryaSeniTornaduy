...
<div id="main">
	<div class="container">
        <div class="row">
            <div class="col-6">
                <h3>Jadi Seniman</h3>
				<small>Dengan mendaftar jadi seniman, anda dapat membuat event</small>
            </div>
        </div>
		<div class="row mb-5">
			<div class="col-6">
				<form action="" method="post" enctype="multipart/form-data">
					<label for="name" style="margin-top: 20px;">Nama Seniman</label>
					<div class="input-group">
						<div class="input-group-prepend">
							<span class="input-group-text"><img src="<?= base_url('assets/icons/icons/person.svg') ?>" width="24" height="24"></span>
						</div>
						<input type="name" name="name" class="form-control" value="<?= $name ?>" placeholder="nama seniman" required> <br>
					</div>
                    ...
                    <label for="image" style="margin-top: 20px;">Profil</label> <br>
                    <input type="file" name="image" accept="image/*" required> <br>
					<small>*format jpeg/jpg/png</small> <br>
					<small class="text-danger"><?= form_error('image') ?></small>
                    
                    <label for="tdup" style="margin-top: 20px;">Profil</label> <br>
