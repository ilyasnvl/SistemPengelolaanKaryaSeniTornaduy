								...
								<div class="tab-pane fade show active" id="peserta" role="tabpanel" aria-labelledby="pills-peserta-tab">
									...
									<nav>
										<div class="nav nav-tabs" id="nav-tab" role="tablist">
											<a class="nav-item nav-link active" id="nav-pendaftar-tab" data-toggle="tab" href="#nav-pendaftar" role="tab" style="color: inherit" aria-controls="nav-pendaftar" aria-selected="false"><i class="fa fa-users"></i> Data Pendaftar Karya (<?= $jumlah_pendaftar ?>)
											</a>
											<a class="nav-item nav-link" id="nav-peserta-tab" data-toggle="tab" href="#nav-peserta" role="tab" style="color: inherit" aria-controls="nav-peserta" aria-selected="true"><i class="fa fa-money"></i> Data Pembeli Karya (<?= $jumlah_konfirmasi ?>)
											</a>
										</div>
									</nav>
									<div class="tab-content" id="nav-tabContent">
										<div class="tab-pane fade show active" id="nav-pendaftar" role="tabpanel" aria-labelledby="nav-pendaftar-tab">
											...
											<div class="alert alert-primary alert-dismissible fade show my-3" role="alert">
												Data dibawah ini adalah <b style="color:inherit">semua</b> pendaftar karya
											</div>
										...
										<div class="tab-pane fade" id="nav-peserta" role="tabpanel" aria-labelledby="nav-peserta-tab">
											...
											<div class="alert alert-success alert-dismissible fade show my-3" role="alert">
												Data dibawah ini adalah pembeli karya yang <b style="color:inherit">sudah fix</b>
											</div>
