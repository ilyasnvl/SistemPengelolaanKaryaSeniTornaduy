    ...
    <section id="about">
        <div class="container mb-50">
            <div class="card shadow">
                <div class="card-body">
                    <h2>Edit Karya</h2>
                    <small>Maksimalkan karyamu semenarik mungkin yaks ^_^</small>
                        ...
                        <div class="row justify-content-center my-3">
                            ...
                            <div class="col-md-6">
                                <div class="my-2">
                                    ...
                                    <img id="showingImage" src="<?= base_url('assets/images/images-event/' . $image) ?>"
                                        width="100%" height="250px" alt="masukan gambar karya" /> <br> <br>
                                    <input type="file" name="image_new" onchange="showImage(this);" accept="image/*" />
                                    <br>
                                    ...
                                    <div class="form-group">
                                        <label for="tinyint">Tipe karya <br>
                                            ...
                                            <!-- <input type="radio" name="type" value="0"
                                                <?php if ($type == 0) echo "checked" ?> <?= $readonly ?>> Free / Gratis -->
                                            <input type="radio" name="type" value="1"
                                                <?php if ($type == 1) echo "checked" ?> <?= $readonly ?>> Paid /
                                            Berbayar <br>
