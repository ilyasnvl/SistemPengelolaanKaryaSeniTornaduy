	...
	<div class="modal-dialog" role="document">
		<div class="modal-content">
			...
			<div class="modal-body">
				...
				<p>Untuk melakukan pencairan dana, harap mengirim link penyimpanan cloud (Google drive, Dropbox, One Drive, dll) dan sharing ke alamat email TORNADUY di <strong>manajemen@TORNADUY.id</strong>, dan copykan link pada form dibawah ini:</p>
