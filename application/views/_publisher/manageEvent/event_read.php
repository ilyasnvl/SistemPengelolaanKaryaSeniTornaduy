								...
								<div class="card">
									...
									<?php if (count($tiket) < 1) { ?>
										<div class="alert alert-warning" role="alert">
											karya ini <strong>belum</strong> memiliki harga. Pilih menu <i>infromasi harga</i> untuk membuatnya ~
										</div>
									<?php } ?>
									...
									<div class="row no-gutters">
										...
										<div class="col-md-5">
											<div class="card-body">
												...
												?>
												<h3><?= $event->title ?></h3>
												<h6 class="mt-30" style="margin-bottom:0px"><strong>Tahun Karya :</strong></h6>
												<p><?= $event->tahun_karya ?></p>
												<h6 class="mt-30" style="margin-bottom:0px"><strong>Media :</strong></h6>
												<p><?= $event->media ?></p>
												<h6 class="mt-30" style="margin-bottom:0px"><strong>Dimensi :</strong></h6>
												<p><?= $event->dimensi ?></p>
												...
												<h6 class="mt-30" style="margin:10px 0px 0px 0px"><strong>Lokasi :</strong></h6>
												...
												<div class="alert alert-danger" role="alert">
													<strong>karya ditolak</strong> <br> 
												...
												<a href="<?= site_url('manage/'.$event->id.'/edit') ?>"
													class="btn btn-xs btn-warning"><i class="fa fa-edit"></i> Update Karya
												</a>
												<a href="<?= site_url('manage/'.$event->id.'/hapus') ?>"
                                       				 class="btn btn-xs btn-danger" onclick="return confirm('Apakah anda ingin menghapus karya ini ?')"><i class="fa fa-trash"></i>Delete Karya
												</a>

												<?php if (count($tiket) > 0 && $event->status == 'draft') { ?>
													<a href="#" class="btn btn-primary"  data-toggle="modal" data-target="#ajukan_event<?= $event->id ?>">Ajukan Karya <i class="fa fa-send"></i></a>
												<?php } ?>
											</div>
										</div>
									</div>
        ...
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="ajukan_event"><strong>Konfirmasi pengajuan karya</strong></h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                    </button>
                </div>
                <div class="modal-body">
					<p><strong>Nama karya : <?= $event->title ?></strong></p>
					<ul>
						<!-- <li>Setelah diajukan anda tidak bisa menambah, mengubah, dan menghapus tiket</li> -->
						<li>Setelah diajukan perubahan data pada karya akan dibatasi</li>
					</ul>
					<br>
					<p>Klik tombol <strong>Ajukan</strong>, jika anda yakin ingin mengajukan karya sekarang</p>
                </div>
