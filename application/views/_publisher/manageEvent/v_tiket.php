									...
									<div class="list-group">
										<?php foreach ($tiket as $row) { ?>
											<span class="list-group-item list-group-item-action list-group-item-warning">
												...
												<small><?= 'Stock Tersisa ' . $row->quota .' lagi' ?></small>
											</span>
										<?php } ?>
									</div> 
								<?php } else { ?> 
								<div class="alert alert-warning" role="alert">
									Klik tombol <strong>tambah </strong> untuk menentukan harga dan stok!
								</div>
								<?php if ($status != 'approved'){ ?>
								<a href="#">
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="tiketform">Tambah Harga</h5>
                ...
                <div class="modal-body">
					<form action="<?= site_url('manage/'.$id.'/tambah-tiket') ?>" method="post">
						...
						<div class="form-group">
							<label for="int">Stok Karya</label>
							<input type="text" class="form-control" name="quota" id="quota" placeholder="Stok Karya" required/>
						</div>
						<div class="form-group">
