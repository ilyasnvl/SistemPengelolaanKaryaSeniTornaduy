...
<main id="main">
    <section id="about" style="min-height:70vh">
        ...
        <?php if ($isPublisher === false): ?>
            <div class="row justify-content-center my-5">
                <div class="col-4 text-center my-5">
                    ...
                    Anda harus jadi seniman untuk membuat karya, silahkan upgrade akun dahulu. <br>
                    <a href="<?= site_url('manage/jadi-publisher') ?>" class="btn primary-btn" style="margin: 20px 0 10px 0;">Daftar Seniman</a>
                </div>
            </div>
        <?php elseif($publisher_status == 'submitted'): ?>
            <div class="row justify-content-center my-5">
                <div class="col-4 text-center my-5">
                    Akun anda sedang kami tinjau, jika sudah selesai anda dapat membuat karya. Tunggu yaa. <br>
                </div>
            </div>
        ...
        <?php else: ?>
            <div class="row my-5">
                <div class="col-8">
                    <h3>Daftar karya anda</h3>
                    <small>Selamat datang di halaman kelola karya. Have a nice day :)</small>
                </div>
                <div class="col-4">
                    <div class="float-right">
                        <a href="<?= site_url('manage/buat-event') ?>"  class="btn primary-btn" style="margin: 10px 0 10px 0;">
                        <i class="fa fa-plus"></i> Buat Karya</a>
                    </div>
                </div>
            </div>
            <div class="row my-5">
                <?php if ($event_data == NULL): ?>
                    <h5 class="col-12 mb-100">Anda belum membuat karya.</h5>
                <?php else: ?>
                            ...
                            <div class="card-body" style="min-height:190px">
                                ...
                                <div class="btn-group" role="group">
                                    ...
                                    <!-- <?php if ($event->status == 'approved'): ?> -->
                                        ...
                                        class="btn btn-sm btn-danger" onclick="return confirm('Apakah anda ingin menghapus karya ini ?')"><i class="fa fa-trash"></i></a>
                                    <?php endif ?>
                                </div>
                            </div>
                        </div>
