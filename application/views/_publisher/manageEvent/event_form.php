    ...
    <section id="about">
        <div class="container mb-50">
            <div class="card shadow">
                <div class="card-body">
                    <h2>Buat Karya</h2>
                    <small>Buat karyamu semenarik mungkin yaks ^_^</small>
                    <form action="" method="post" enctype="multipart/form-data">
                        <div class="row justify-content-center my-3">
                            <div class="col-md-6">
                                <div class="my-2">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="title" name="title" class="form-control" value="<?= $title ?>"
                                            placeholder="nama karya" required>
                                    </div>
                                ...
                                <div class="my-2">
                                    <label for="title">Tahun karya</label>
                                    <div class="input-group">
                                        <div class="input-group-prepend">
                                            <span class="input-group-text"><img
                                                    src="<?= base_url('assets/icons/icons/person.svg') ?>" width="24"
                                        ...
                                        <input type="tahun_karya" name="tahun_karya" class="form-control" value="<?= $tahun_karya ?>"
                                            placeholder="tahun karya" required>
                                    </div>
                                    <small class="text-danger"><?= form_error('tahun_karya') ?></small>
                                </div>
                                ...
                                <div class="my-2">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="media" name="media" class="form-control" value="<?= $media ?>"
                                            placeholder="media" required>
                                    </div>
                                    <small class="text-danger"><?= form_error('media') ?></small>
                                </div>

                                <div class="my-2">
                                    <label for="title">Dimensi</label>
                                    <div class="input-group">
                                        <div class="input-group-prepend">
                                            <span class="input-group-text"><img
                                                    src="<?= base_url('assets/icons/icons/person.svg') ?>" width="24"
                                        ...
                                        <input type="dimensi" name="dimensi" class="form-control" value="<?= $dimensi ?>"
                                            placeholder="dimensi" required>
                                    </div>
                                    <small class="text-danger"><?= form_error('dimensi') ?></small>
                                </div>
                                    ...
                                    <div class="row">
                                        <div class="col">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <?php $startMinDate = new DateTime('+1 day'); ?>
                                        ...
                                        <div class="col">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <?php $endMinDate = new DateTime('+1 day'); ?>
                                                <input type="date" class="form-control" name="end_date"
                                                    min="<?= $endMinDate->format('Y-m-d') ?>" value="<?= $end_date; ?>"
                                                    required />
                                            </div>
                                            <small class="text-danger"><?= form_error('start_date') ?></small>
                                        </div>
                                ...
                                <div class="my-2">
                                    ...
                                    <div class="input-group">
                                        <textarea name="location" class="form-control"
                                            placeholder="Alamat lengkap"><?= $location ?></textarea>
                                    </div>
                            ...
                            <div class="col-md-6">
                                <div class="my-2">
                                    <label for="file">Banner Karya <?= form_error('event_image') ?></label> <br>
                                    <img id="showingImage" src="#" alt="masukan gambar karya" /> <br> <br>
                                    <input type="file" name="image" value="<?= $image; ?>" onchange="showImage(this);"
                                        accept="image/*" required /> <br>
                                    <small class="text-danger">*Ukuran maksimal 1 Mb</small>
                                </div>
                                <div class="my-2">
                                    <div class="form-group">
                                        <label for="tinyint">Tipe karya <br>
                                            <!-- <input type="radio" name="type" value="0"
                                                <?php if ($type == 0) echo "checked" ?>> Free / Gratis -->
                                            <input type="radio" name="type" value="1"
                                                <?php if ($type == 1) echo "checked" ?>> Paid / Berbayar <br>
                                    </div>
                                </div>
                                <div class="my-2">
                                    <div class="form-group">
                        ...
                        <div class="row justify-content-center my-2">
                            <div class="col-12">
                                ...
                                <div class="text-center">
                                    ...
                                    <a href="<?= site_url('manage') ?>" class="btn btn-dark">Batal</a>
                                </div>
                            </div>
                        </div>
                    </form>
