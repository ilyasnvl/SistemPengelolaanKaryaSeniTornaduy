...
<main id="main" style="min-height: 90vh">
    ...
    <section id="about">
        <div class="container">
            <div class="row">
                <h3>
                    <strong>Karya Seni : <?= $myTicket->title ?></strong>
                </h3>
            </div>
            <div class="row">
                <div class="col-lg-12">
                        ...
                        <div class="row no-gutters">
                            ...
                            <div class="col-md-4">
                                <div class="card-body">
                                    ...
                                    <h6 style="margin:10px 0px 0px 0px"><strong> Lokasi :</strong></h6>
                            ...
                            <div class="col-md-4">
                                <div class="card-body">
                                    ...
                                    <a href="#">
                                        <button class="btn btn-success w-100" enabled>Pembayaran berhasil
                                            </button>
                                    </a>
