    ...
    <section id="portfolio" class="clearfix">
      <div class="container">
        <header class="section-header mt-5">
          <h3 class="section-title text-left">Karya yang anda pesan</h3>
        </header>

        <div class="row wow fadeInUp" style="margin-bottom: 100px">
            <?php if ($myEvent == NULL) { ?>
                <div class="col-12">
                    <h5>Anda belum membeli karya, ayo pilih karya yang kamu suka. <a href="<?= base_url() ?>">Klik disini</a></h5>
                </div>
            <?php } else {
                            ...
                            <span class="card-text">
                                <div class="row">
                                    <div class="col-12" style="font-size: 14px">
                                        ...
                                        <i class="fa fa-solid fa-calendar-check"></i> Tahun Karya : <?= $row->tahun_karya . '<br>'  ?>
                                        <i class="fa fa-solid fa-photo-film"></i> Media : <?= $row->media . '<br>' ?> 
                                        <i class="fa fa-map-marker"></i> Lokasi : <?= $row->city_name . '<br>' ?>
                                        <?php 
                                        if ($startDate == date('Y-m-d')) { ?>
                                            <label class="badge badge-secondary"><strong>Done</strong></label>    
                                        <?php } else { 
                                            switch ($row->status) {
                                                case 'booking': ?>
